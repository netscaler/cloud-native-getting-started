...
create table mytestconfigmap (id int);
...
CREATE USER mpspostgres WITH SUPERUSER CREATEROLE LOGIN PASSWORD 'netscalermas$123';
CREATE USER mpsroot WITH SUPERUSER CREATEROLE LOGIN PASSWORD 'netscalermas$123';
CREATE DATABASE mpsdb;                                                                                                                                    

\c mpsdb

CREATE SCHEMA "Owner";
CREATE ROLE "Owner" NOINHERIT ROLE mpsroot;
GRANT all on schema "Owner" to "Owner";
